...
final kSourceSansProBold = GoogleFonts.mulish(
  fontWeight: FontWeight.w700,
);

final kSourceSansProSemibold = GoogleFonts.mulish(
  fontWeight: FontWeight.w600,
);

final kSourceSansProMedium = GoogleFonts.mulish(
  fontWeight: FontWeight.w500,
);

final kSourceSansProregular = GoogleFonts.mulish(
  fontWeight: FontWeight.w400,
);

final kSourceSansProLight = GoogleFonts.mulish(
